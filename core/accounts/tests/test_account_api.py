...
class TestAccountApi:
    def test_post_registration_response_201_status(self, api_client):
        ...
        assert response.data["email"] == "testss@testss.com"

    def test_post_registration_invalid_data_response_400_status(self, api_client):
        url = reverse("accounts:api-v1:registration")
        data = {
            "email": "invalid-email",
            "password": "Amirali83!",
    ...
    def test_put_change_password_response_400_status(self, api_client, common_user):
        url = reverse("accounts:api-v1:change-password")
        data = {
            "old_password": "Amirali83!",
            "new_password": "NewPass456!",
    ...
    def test_verified_user_can_login(self, api_client, common_user):
        url = reverse("accounts:api-v1:token-login")
        data = {"email": "tests@tests.com", "password": "Amirali83!"}
        response = api_client.post(url, data, format="json")
